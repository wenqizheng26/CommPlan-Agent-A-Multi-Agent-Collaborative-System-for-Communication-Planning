export const roleModeNames={deterministic:'确定性规则',llm:'本机 Qwen',stub:'测试替身',deterministic_fallback:'模型不可用或建议无效，已降级',bounded_policy:'受控调度策略'};
export const reviewDecisionNames={pass:'通过',needs_input:'需补充或核对假设',not_applicable:'模型适用性待核对',recalculate:'请求重新计算'};
